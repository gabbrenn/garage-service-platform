...
android {
    ...
    buildTypes {
        release {
            // For local sharing without Play Console, we'll generate an unsigned release APK
            // that can be installed via adb or shared directly. For Play/App bundles, configure signing.
